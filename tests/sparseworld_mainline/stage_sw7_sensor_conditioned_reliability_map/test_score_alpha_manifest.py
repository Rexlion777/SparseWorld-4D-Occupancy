...
PATH = ROOT / "reports/lidar_system_algorithm/sparseworld_mainline/stage_sw7_sensor_conditioned_reliability_map/score_alpha_visualization_manifest.json"
...
def test_score_alpha_manifest() -> None:
    ...
    for row in payload["rows"][:5]:
        ...
        assert row["alpha_mode"] in {"top1_score", "contributor_strength", "final_reliability"}
